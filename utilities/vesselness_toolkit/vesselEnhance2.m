function [hessian, enhI, evCell1,evCell2, evalCell] = vesselEnhance2(I,s,gamma)
%VESSELENHANCE Enhance vesselness and return hessian also
...
for i = 1 : len
    ...
    if (e(sortindex(2)) < 0) % if the smaller eigenvalue is negative, for bright object
        vesselness = findVesselness(D(sortindex(1)),D(sortindex(2)),S,c,beta);
