    ...
    for J=1:I-1,
        ...
        if OMG_full(I,J)==1, % I and J are connected
            ...
            dist_I_to_J=sqrt((oldNodePositions.x(I)-oldNodePositions.x(J)).^2 +...
                ...
                (oldNodePositions.z(I)-oldNodePositions.z(J)).^2);
...
newNodePositions=struct('x',zeros(1,n),'y',zeros(1,n),'z',zeros(1,n));
...
%     oldNodePositions.x(where_is_I)
    ...
    newNodePositions.z(I)=sum(oldNodePositions.z(where_is_I))/length(where_is_I);
